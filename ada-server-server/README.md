# No description provided (generated by Swagger Codegen https://github.com/swagger-api/swagger-codegen) - Swagger Ada Server
...
------------- | ------------- | -------------
[**1**](AutenticacionApi.md#1) | **POST** /api/fe/Autenticacion/api/ValidacionCertificado | 
[**2**](AutenticacionApi.md#2) | **GET** /api/fe/Autenticacion/api/Semilla | 
[**3**](RecepcionApi.md#3) | **POST** /api/fe/Recepcion/api/ecf | 
[**4**](RecepcionApi.md#4) | **POST** /api/fe/AprobacionComercial/api/ecf | 


## Models
 - [.Models.MVCErrorResponse_Type](MVCErrorResponse_Type.md)
 - [.Models.MVCErrorResponse_items_Type](MVCErrorResponse_items_Type.md)
